...
1. Define the product architecture and object model.
...
Desktop, IDE extensions, CLI, CI, and future clients consume the same core objects through the same public API. No UI should consume analyzer output directly.
